...
class FeedBack(discord.ui.View):
    ...
    async def feedbacklaunch(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.response.send_message("écris maintenant ton commentaire", ephemeral=True)
        pl = []
    ...
    async def star_3(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.tab[0] = interaction.user
        self.tab[2] = 3
        await interaction.response.send_message("tu a mis 3 étoile", ephemeral=True)
    ...
    async def star_4(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.tab[0] = interaction.user
        self.tab[2] = 4
        await interaction.response.send_message("tu a mis 4 étoile", ephemeral=True)
    ...
    async def star_5(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.tab[0] = interaction.user
        self.tab[2] = 5
        await interaction.response.send_message("tu a mis 5 étoile", ephemeral=True)
    ...
    async def finish(self, interaction: discord.Interaction, button: discord.ui.Button):
        if not None in self.tab:
            ...
            await interaction.response.send_message(
                "attention tu n'a pas mis d'étoile ou tu n'a pas mis un commentaire !", ephemeral=True)
            # await interaction.response.defer()
...
# Commandes
@tree.command(name="ptsfidelite", guild=discord.Object(id=1046437841447686226), description="ajoute les point de fidéliter")
...
async def ptsfidelite(interaction: discord.Interaction, acheteur: discord.Member , param: str, nbre_point: int , required=True):
    if param == 'reset':
